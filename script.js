...
uiText.tr = {
  navServices: "Hizmetler", navGames: "Oyunlar", navAssets: "Assetler", navOtherWorks: "Diğer İşler", navReferences: "Referanslar", navContact: "İletişim",
...
uiText.ar = {
  navServices: "الخدمات", navGames: "الألعاب", navAssets: "الأصول", navOtherWorks: "أعمال أخرى", navReferences: "المراجع", navContact: "تواصل",
...
uiText.zh = {
  navServices: "服务", navGames: "游戏", navAssets: "资产", navOtherWorks: "其他作品", navReferences: "客户", navContact: "联系",
...
uiText.ru = {
  navServices: "Услуги", navGames: "Игры", navAssets: "Ассеты", navOtherWorks: "Другие работы", navReferences: "Референсы", navContact: "Контакты",
...
const applyStaticTranslations = () => {
  ...
  const navSelectors = [
    ...
    [".primary-nav a:nth-child(4)", "navOtherWorks"],
    [".primary-nav a:nth-child(5)", "navReferences"],
